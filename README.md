...
各项目的实验报告与代码文件详见各项目所属文件夹。感谢您的阅读！如有不足恳请批评指正！

### 目录结构

```text
Project/
├── Project1-SM4/                     # 项目一：SM4算法实现与优化
│   ├── SM4_Basic/                    # 基础实现
│   ├── SM4_TT/                       # T-Table优化实现
...
│   └── README.md                     # 项目二实验报告
├── Project3-Poseidon2/               # 项目三：Poseidon2哈希算法circom电路实现
│   ├── circuits/                     # Circom电路
│   ├── params/                       # 参数文件
│   ├── set_result/                   # 证明与验证工件
│   ├── exp_result/                   # 运行截图
│   ├── calc_poseidon2.js             # JS计算脚本
│   ├── test_js_only.js               # JS独立测试脚本
│   ├── test_poseidon2.js             # 综合测试脚本
│   ├── input.json                    # 输入数据脚本
│   ├── package.json                  # 整合脚本
│   └── README.md                     # 项目三实验报告
├── Project4-SM3/                     # 项目四：SM3算法实现与优化
│   ├── SM3_Basic/                    # 基础实现
│   ├── SM3_Opti1/                    # 循环展开优化实现
│   ├── SM3_Opti2/                    # AVX2/SIMD硬件加速实现
│   ├── Test_Results/                 # 性能测试结果截图
│   └── README.md                     # 项目四实验报告
├── Project5-SM2/                     # 项目五：SM2算法实现与优化
│   ├── SM2_Basic/                    # 基础实现
│   ├── SM2_Opti/                     # 多技术融合优化实现
│   ├── Test_Results/                 # 性能测试结果
